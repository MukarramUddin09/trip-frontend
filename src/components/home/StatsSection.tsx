...
export function StatsSection() {
  return (
    <section className="relative py-20" style={{ background: "linear-gradient(180deg, transparent 0%, rgba(13,21,38,0.6) 50%, transparent 100%)" }}>
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-y-12 px-6 md:grid-cols-4">
        {STATS.map((s, i) => (
          <div key={s.label} className="relative flex flex-col items-center text-center" style={i < STATS.length - 1 ? { borderRight: "1px solid rgba(255,255,255,0.05)" } : undefined}>
