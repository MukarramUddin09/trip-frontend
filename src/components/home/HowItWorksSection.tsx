        ...
        <div className="relative mt-20 grid gap-12 md:grid-cols-4">
          {STEPS.map(({ Icon, title, desc }, i) => (
            <div key={title} className="reveal relative flex flex-col items-center text-center">
              <div className="grid h-14 w-14 place-items-center rounded-full font-display text-lg font-bold text-white" style={{ background: "linear-gradient(135deg,#3B82F6,#06B6D4)", boxShadow: "0 0 28px rgba(59,130,246,0.45)" }}>
                {i + 1}
              </div>
