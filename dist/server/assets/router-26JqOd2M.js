import { Q as reactExports, E as isPromise, F as isRedirect, C as isNotFound, y as invariant$1, f as createControlledPromise, Z as rootRouteId, G as isServer$1, t as functionalUpdate$1, a as arraysEqual, g as createLRUCache, d as compileDecodeCharMap, $ as trimPath, Y as rewriteBasepath, e as composeRewrites, P as processRouteTree, N as processRouteMasks, X as resolvePath, c as cleanPath, a1 as trimPathRight, M as parseHref, o as executeRewriteInput, z as isDangerousProtocol, S as redirect, s as findSingleMatch, j as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, b as buildRouteBranch, x as interpolatePath, L as nullReplaceEqualDeep, U as replaceEqualDeep$1, J as last, i as decodePath, q as findFlatMatch, r as findRouteMatch, w as hasKeys, p as executeRewriteOutput, l as encodePathLikeUrl, a0 as trimPathLeft, H as joinPaths, a3 as useRouter, k as dummyMatchContext, K as matchContext, v as getDefaultExportFromCjs, V as requireReactDom, n as exactPathTest, T as removeTrailingSlash, R as React, I as jsxRuntimeExports, B as isModuleNotFoundError, a2 as useHydrated, m as escapeHtml, A as isInlinableStylesheet, u as getAssetCrossOrigin, W as resolveManifestAssetLink, O as Outlet } from "./server-JUmjKwJO.js";
...
const appCss = "/assets/styles-C9qc7L9r.css";
...
function useTheme() {
  return reactExports.useContext(ThemeCtx);
}
...
const authApi = {
  ...
  google: (credential) => apiFetch("/api/auth/google", {
    method: "POST",
...
const travelApi = {
  search: (body) => apiFetch("/api/travel/search", {
    method: "POST",
    body: JSON.stringify(body)
  }),
  book: (body) => apiFetch("/api/travel/book", {
    method: "POST",
    body: JSON.stringify(body)
  }),
  bookings: (page = 1) => apiFetch(`/api/travel/bookings?page=${page}`),
  localRides: (body) => apiFetch("/api/travel/local-rides/search", {
    method: "POST",
    body: JSON.stringify(body)
  })
};
const hotelApi = {
  search: (params) => {
    ...
    return apiFetch(`/api/hotels/search?${q}`);
  },
  get: (id2) => apiFetch(`/api/hotels/${id2}`),
  book: (body) => apiFetch("/api/hotels/book", { method: "POST", body: JSON.stringify(body) }),
  bookings: () => apiFetch("/api/hotels/bookings")
};
const tripApi = {
  plan: (body) => apiFetch("/api/trips/plan", { method: "POST", body: JSON.stringify(body) })
};
const entertainmentApi = {
  search: (city, type) => {
    ...
    return apiFetch(`/api/entertainment/search?${q}`);
  },
  book: (body) => apiFetch("/api/entertainment/book", { method: "POST", body: JSON.stringify(body) })
};
const alertApi = {
  list: (city) => apiFetch(`/api/alerts?city=${encodeURIComponent(city)}`),
  weather: (city) => apiFetch(`/api/alerts/weather?city=${encodeURIComponent(city)}`),
  subscribe: (city) => apiFetch("/api/alerts/subscribe", {
    method: "POST",
...
const feedbackApi = {
  ...
  mine: () => apiFetch(`/api/feedback/my`)
};
const paymentApi = {
  history: () => apiFetch("/api/payments/history"),
  initiate: (body) => apiFetch("/api/payments/initiate", {
    method: "POST",
    body: JSON.stringify(body)
  }),
  verify: (body) => apiFetch("/api/payments/verify", {
    method: "POST",
    body: JSON.stringify(body)
  })
};
const itineraryApi = {
  ...
  create: (body) => apiFetch("/api/itineraries", { method: "POST", body: JSON.stringify(body) }),
  get: (id2) => apiFetch(`/api/itineraries/${id2}`)
};
const ADMIN_EMAIL = "mukarramuddin09@gmail.com";
const AuthCtx = reactExports.createContext(null);
function redirectPath(user) {
...
function AuthProvider({ children }) {
  ...
  const applySession = reactExports.useCallback(async (token, u) => {
    setToken(token);
    setUser(u);
    return redirectPath(u);
  }, []);
  const loginWithGoogle = reactExports.useCallback(
    async (credential) => {
  ...
  const loginWithPassword = reactExports.useCallback(
...
const Car = createLucideIcon("car", __iconNode$g);
const __iconNode$f = [
...
const Hotel = createLucideIcon("hotel", __iconNode$f);
const __iconNode$e = [
...
const Ticket = createLucideIcon("ticket", __iconNode$3);
const __iconNode$2 = [
...
const NAV = [
  ...
  { to: "/plan-trip", label: "Plan Trip", icon: Map$1 },
  { to: "/booking", label: "Travel Booking", icon: TramFront },
...
function NavList({ onNavigate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-1 p-3", children: NAV.map(({ to, label, icon: Icon2 }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        className: cn(
          ...
          active && "bg-[color-mix(in_oklab,var(--brand)_18%,transparent)] text-sidebar-foreground glow-indigo"
        ),
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: cn("h-4.5 w-4.5 shrink-0", active && "text-[var(--brand)]") }),
...
function AppShell() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen text-foreground", children: [
    ...
    authError && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-destructive/90 text-destructive-foreground text-center text-sm py-2 px-4", children: [
      authError,
      " — run ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono", children: "npm run dev" }),
      " in ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono", children: "tripai-backend" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "blob-bg", "aria-hidden": true }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "fixed inset-y-0 left-0 z-30 hidden w-64 border-r border-sidebar-border bg-sidebar/70 backdrop-blur-xl md:flex md:flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-16 items-center gap-2 px-5 border-b border-sidebar-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-[var(--brand)] to-[var(--teal)] text-white font-bold", children: "T" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-bold tracking-tight", children: "TripAI" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavList, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-sidebar-border p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LogOut, { className: "h-4.5 w-4.5 shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Log Out" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 px-3 text-xs text-muted-foreground", children: "v1.0 · Travel smarter with AI" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.aside,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-16 items-center justify-between px-5 border-b border-sidebar-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-[var(--brand)] to-[var(--teal)] text-white font-bold", children: "T" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-lg font-bold", children: "TripAI" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setMobileOpen(false), className: "p-2 rounded-md hover:bg-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavList, { onNavigate: () => setMobileOpen(false) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:pl-64", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-border bg-background/60 px-4 backdrop-blur-xl md:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "md:hidden p-2 rounded-md hover:bg-accent", onClick: () => setMobileOpen(true), "aria-label": "Open menu", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-7 w-7 place-items-center rounded-md bg-gradient-to-br from-[var(--brand)] to-[var(--teal)] text-white font-bold text-xs", children: "T" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold", children: "TripAI" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex flex-1 max-w-xl items-center gap-2 rounded-lg border border-border bg-card/60 px-3 py-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { className: "hidden lg:inline rounded bg-muted px-1.5 py-0.5 text-[10px] text-muted-foreground", children: "⌘K" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: !mounted ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-4 w-4", "aria-hidden": true }) : theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-4 w-4" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "relative grid h-9 w-9 place-items-center rounded-lg border border-border bg-card/60 hover:bg-accent", "aria-label": "Notifications", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "h-4 w-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1.5 right-1.5 h-2 w-2 rounded-full bg-[var(--teal)]" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-9 w-9 place-items-center rounded-full bg-gradient-to-br from-[var(--brand)] to-[var(--teal)] text-white text-sm font-semibold", title: user?.email || "", children: authLoading ? "…" : initials })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "p-4 md:p-6 lg:p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
...
function ProtectedRoute({ children }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid min-h-[40vh] place-items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-[var(--brand)]" }) });
  }
  if (!user) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
}
function AdminRoute$1({ children }) {
  ...
  if (loading || !user || !isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid min-h-screen place-items-center", style: { background: "#050A14" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-8 w-8 animate-spin text-[#3B82F6]" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
}
...
function AppLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppShell, {}) });
}
...
const themeInitScript = `(function(){try{var t=localStorage.getItem("tripai-theme");document.documentElement.classList.toggle("dark",t!=="light");}catch(e){document.documentElement.classList.add("dark");}})();`;
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, {}) }) }) });
}
const $$splitComponentImporter$f = () => import("./signup-DXWVUgB0.js");
const Route$f = createFileRoute("/signup")({
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./settings-Bis0qPL3.js");
const Route$e = createFileRoute("/settings")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./rides-DtRswV5X.js");
const Route$d = createFileRoute("/rides")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./plan-trip-wGp0XvB3.js");
const Route$c = createFileRoute("/plan-trip")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./payments-B95Tto_7.js");
const Route$b = createFileRoute("/payments")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./login-De0REKsQ.js");
const Route$a = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./itineraries-QeY7teHt.js");
const Route$9 = createFileRoute("/itineraries")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./hotels-DJotj4xQ.js");
const Route$8 = createFileRoute("/hotels")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./feedback-CsL6m097.js");
const Route$7 = createFileRoute("/feedback")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./entertainment-CTnj8WJ0.js");
const Route$6 = createFileRoute("/entertainment")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./dashboard-BojkftaE.js");
const Route$5 = createFileRoute("/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./booking-CGr-2wBa.js");
const Route$4 = createFileRoute("/booking")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./alerts-B_VekY-w.js");
const Route$3 = createFileRoute("/alerts")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin-By0Cnywy.js");
const Route$2 = createFileRoute("/admin")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./_-BCSjCjp9.js");
const Route$1 = createFileRoute("/$")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DkYaXOe5.js");
...
const RidesRoute = Route$d.update({
  id: "/rides",
  path: "/rides",
  getParentRoute: () => Route$g
});
const PlanTripRoute = Route$c.update({
  id: "/plan-trip",
  path: "/plan-trip",
  getParentRoute: () => Route$g
});
...
const ItinerariesRoute = Route$9.update({
  id: "/itineraries",
  path: "/itineraries",
  getParentRoute: () => Route$g
});
const HotelsRoute = Route$8.update({
  id: "/hotels",
  path: "/hotels",
  getParentRoute: () => Route$g
});
...
const EntertainmentRoute = Route$6.update({
  id: "/entertainment",
  path: "/entertainment",
  getParentRoute: () => Route$g
});
...
const BookingRoute = Route$4.update({
  id: "/booking",
  path: "/booking",
  getParentRoute: () => Route$g
});
