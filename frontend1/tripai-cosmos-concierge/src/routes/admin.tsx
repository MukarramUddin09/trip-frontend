  ...
  return (
    <div className="min-h-screen" style={{ background: "#050A14" }}>
      ...
      <main className="mx-auto max-w-5xl px-6 pt-32 pb-24">
        <div className="inline-flex items-center gap-2 rounded-full px-3 py-1 font-mono text-[10px] uppercase tracking-wider text-[#F59E0B]"
        ...
        <p className="mt-2 text-[#94A3B8]">Platform overview &amp; controls.</p>
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {["Users", "Bookings", "System health"].map((t) => (
            <GlassCard key={t} className="p-6">
              ...
              <p className="mt-3 text-sm text-[#94A3B8]">Placeholder.</p>
            </GlassCard>
          ))}
        </div>
        <div className="mt-10">
